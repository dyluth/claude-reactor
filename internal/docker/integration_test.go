...
func TestDockerIntegrationWorkflow(t *testing.T) {
	...
	archDetector := architecture.NewDetector()
...
func TestDockerErrorRecovery(t *testing.T) {
	...
	t.Run("stop nonexistent container", func(t *testing.T) {
		...
		err := recoveryMgr.StopContainerWithRecovery(ctx, "nonexistent-container-id", recoveryConfig)
...
func TestDockerComponentIntegration(t *testing.T) {
	...
	logger := logging.NewLogger("info") // Less verbose for component tests
	archDetector := architecture.NewDetector()
